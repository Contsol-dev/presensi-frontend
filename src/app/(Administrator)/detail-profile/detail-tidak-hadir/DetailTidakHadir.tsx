...
export default function DetTidakHadir(){
                ...
                <table className="table-auto w-full text-center text-[10px]">
                    <thead className='bg-gray-300'>
                        <tr>
                            ...
                            <th className='p-1' rowSpan={2}>Status Ganti Jam</th>
                        </tr>
                        <tr>
                    ...
                    <tbody className='bg-white'>
                        <tr className=' relative border-b-2'>
                            ...
                            <td className='p-1'>--</td>
                            <td className='p-1 flex gap-1 justify-center text-red-600'>Tidak Hadir <img src="/info.svg" alt="" onClick={handleChangeInfo} className="cursor-pointer"/></td>
                            <td className='p-1'>Tidak Ganti Jam</td>
                        </tr>
                    </tbody>
                </table>
            </div>
