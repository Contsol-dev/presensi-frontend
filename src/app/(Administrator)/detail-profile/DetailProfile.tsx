...
export default function DetProfile() {
            ...
            <div className="flex flex-col gap-3">
                <table className="table-auto w-full text-center text-[10px]">
                    <thead className='bg-gray-300'>
                        <tr>
                            <th className='p-1 cursor-pointer' rowSpan={2}><input type="checkbox" /></th>
                            ...
                            <th className='border-b-2 border-x-2 p-1' colSpan={2}>Jam Istirahat</th>
                    ...
                    <tbody className='bg-white'>
                        <tr className='relative border-b-2'>
                            ...
                            <td className='p-1'>Membuat tampilan website e-commerce</td>
                            <td className='p-1 flex gap-1 justify-center'>
                                Tidak Hadir <img src="/info.svg" alt="info" onClick={handleChangeInfo} className="cursor-pointer" />
                            </td>
                            <td className='p-1'>Merapikan parkiran motor</td>
                            <td className='p-1'>Kemarin anda absen pulang di kost, jangan diulang</td>
                            <td className='p-1'><img src="/write.svg" alt="edit" onClick={handleChangeCatatan} className="cursor-pointer" /></td>
                            {catatan && (
                                <div className="absolute right-5 -bottom-32 flex flex-col h-fit w-1/3 gap-2 px-2 py-5 shadow-lg bg-slate-100">
                                    <textarea className="w-full p-2 bg-slate-300 rounded-sm focus:outline-none text-xs" placeholder="Tambahkan Catatan Untuk User"></textarea>
                                    <div className='flex justify-end gap-5 w-full text-xs'>
                                        <button>Batal</button>
                                        <button className='bg-h1 py-2 px-5 text-white rounded-lg'>Simpan</button>
                                    </div>
                                </div>
                            )}
                        </tr>
            ...
            <div className="bg-black/50 w-full h-full py-5 left-0 flex fixed justify-center items-center z-30">
                <div className="bg-slate-100 flex flex-col w-[400px] h-full items-center rounded-lg p-5 gap-5">
                    ...
                    <div className="flex flex-col w-full gap-2">
                        ...
                        <span className="w-full bg-slate-300 text-xs whitespace-nowrap  p-2 rounded-sm">https://www.googledrive.com/results?search_query</span>
                    </div>
                    <div className="flex flex-col w-full gap-2">
                        <p>Kategori Izin</p>
                        ...
                        {tambah && (
                            <>
                                ...
                                <input className="shadow-md rounded-lg p-2 text-xs" type="text" placeholder="Tambah Kategori Izin" />
                    ...
                    <button className="cursor-pointer" onClick={handleChangeInfo}>Simpan</button>
                </div>
            </div>
        );
    }
        ...
        <>
            <div className="flex flex-col gap-5 h-screen overflow-auto">
                ...
                <div className="flex flex-col md:flex-row gap-5 text-xs">
                        ...
                        <div className="flex flex-col h-fit gap-2 p-2 shadow-lg bg-slate-100">
                            ...
                            <div className="flex w-full gap-5">
                                <div className="flex w-1/2">
                                    ...
                                    <p className="w-16 rounded-xl text-xs text-center p-1 bg-black text-white">0 X</p>
                                </div>
                                <div className="flex w-1/2">
                    ...
                    <div className="baris-2 flex flex-col w-full md:w-1/3 gap-5">
                        <div className="flex flex-col h-fit gap-2 p-2 shadow-lg bg-slate-100">
                            <div className="flex">
                                <p className="w-2/3">Total jam kerja</p>
                                <p className="w-16 rounded-xl text-xs text-center p-1 bg-green-500 text-white">47:30:50</p>
                            </div>
                            <hr className="border" />
                            <div className="flex">
                                <p className="w-2/3">Total Masuk</p>
                                <p className="w-16 rounded-xl text-xs text-center p-1 bg-black text-white">16 hari</p>
                            </div>
                            <hr className="border" />
                            <div className="flex">
                                <p className="w-2/3">Target</p>
                                <p className="w-16 rounded-xl text-xs text-center p-1 bg-green-500 text-white">1100 jam</p>
                            </div>
                            <hr className="border" />
                            <div className="flex">
                                <p className="w-2/3">Sisa</p>
                                <p className="w-16 rounded-xl text-xs text-center p-1 bg-black text-white">900 Jam</p>
                            </div>
                            <hr className="border" />
                            <div className="flex">
                                <p className="w-2/3">Total Ganti Jam</p>
                                <p className="w-16 rounded-xl text-xs text-center p-1 bg-black text-white">20</p>
                            </div>
                        </div>
                        <div className="flex flex-col h-fit gap-2 px-2 py-5 shadow-lg bg-slate-100">
                            <textarea className="w-full p-2 bg-slate-300 rounded-sm focus:outline-none text-xs" placeholder="Tambahkan Catatan Untuk User"></textarea>
                            <div className='flex justify-end gap-5 w-full text-xs'>
                                <button>Batal</button>
                                <button className='bg-h1 py-2 px-5 text-white rounded-lg'>Simpan</button>
                ...
                <div className='baris-3 flex gap-5'>
                    <div>
                        <DetailData />
                    </div>
                </div>
