...
export default function DetIzin(){
                ...
                <table className="table-auto w-full text-center text-[10px]">
                    ...
                    <tbody className='bg-white'>
                        <tr className=' relative border-b-2'>
                            ...
                            <td className='p-1'>--</td>
                            <td className='p-1 flex gap-1 justify-center text-yellow-400'>Izin <img src="/info.svg" alt="" onClick={handleChangeInfo} className="cursor-pointer"/></td>
