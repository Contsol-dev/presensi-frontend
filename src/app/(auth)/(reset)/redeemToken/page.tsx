        ...
        <div className='h-screen flex flex-col justify-center items-center gap-10  '>
            <div className='flex flex-col justify-center items-center gap-10 adjust'>
                <div className='flex flex-col gap-5 text-center '>
                    ...
                    <p className='text-[32px]'>Periksa email Anda, token hanya bisa digunakan sekali</p>
                </div>
                <div className="flex flex-col gap-8 ">
                    ...
                    <m.div className='w-[370px] text-white flex justify-center mx-auto ' whileHover={{ scale: 1.05 }}>
                        <button onClick={handleRedeemToken}
                            className='bg-h1 rounded-3xl p-4 w-[370px] text-white mt-10 font-semibold text-center  '>Redeem Token
                        </button>
                    </m.div>
                </div>
            </div>
