  ...
  return (
    <div className="search flex gap-3 items-center w-full p-2">
      <div className="formSearch w-2/5 font-inter">
        <h1 className="text-base mb-2 font-bold">Project’s Category</h1>
  ...
  return (
    <div className="flex  gap-2 w-full h-full  p-2">
      <div className="w-1/2  p-2 rounded-sm flex flex-col gap-3 ">
        <h1 className="text-sm font-inter font-bold ">Add New Project</h1>
        <div className="flex flex-col gap-1">
          <p className="text-xs ">Project's Name</p>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            className=" w-full h-20 focus:outline-none p-2 bg-transparent border border-black rounded-md text-xs  "
      ...
      {isModalOpen && (
        <div className="modal-overlay">
          <div className="modal-pengaturan bg-white w-1/3 h-3/4  rounded-xl p-4 overflow-auto">
...
function Table() {
  ...
  return (
    ...
    {showEditPopup && (
      ...
      <h1 className="text-sm font-inter font-bold">Edit Project</h1>
      <div className="flex flex-col gap-1">
        <p className="text-xs ">Project's Name</p>
        <input
          type="text"
    ...
    {showDeleteConfirmation && (
      ...
      {/* Render tabel dengan data yang telah disaring */}
        ...
        <table className="table-auto   rounded-lg ">
          ...
          <tbody>
            {filteredKampus
              ...
              .map((dataKampus: any,  index: number) => (
