...
function Table() {
  ...
  return (
    <div className="tableData gap-10 w-full">
      ...
      <button className="bg-red-600 flex rounded-md text-xs items-center justify-center gap-2 p-1 text-white w-20 font-inter">
